...
function autoCraft2() {
            ...
            if (!gamePage.ironWill && (cntcrafts == 0 || cntcrafts >= 200 || (Object.keys(craftPriority[0]).length > 0 && craftPriority[2] != gamePage.bld.getBuildingExt(craftPriority[0]).meta.val))) {
                var Priority_blds = {
                    ...
                    "ziggurat" : gamePage.bld.getBuildingExt('ziggurat').meta.val > 100 ? 0 :  gamePage.bld.getBuildingExt('ziggurat').meta.val < 20 ? 0 : (gamePage.resPool.get("blueprint").value > 500 ? 0.01 : 0.00000001)
                };
